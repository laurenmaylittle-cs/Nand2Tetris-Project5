...
load Memory.hdl,
output-file Memory-interactive.out,
compare-to Memory-batch.cmp,
...
set in 99,			// RAM[2000] holds value
set load 0,
tick,
output;
tock,
